...
const About = () => (
  <article id="about" className="page">
    ...
    <div className="info">
      ...
      <Svg icon="linkedin" />
      <div>
        <a href="https://www.linkedin.com/in/jorg-nieberg-216ba621/" target="_blank" rel="noreferrer">
          linkedin.com
        </a>
      </div>
    </div>
    <p>
      <a href="/me/jorg.png" className="image" target="_blank" aria-label="portrait of Jorg Nieberg">
        {" "}
      </a>
      <strong>Let me introduce myself,</strong> my name is{" "}
      <a href="https://www.linkedin.com/in/jorg-nieberg-216ba621/" aria-label="LinkedIn page of Jorg Nieberg" target="_blank" rel="noreferrer">
        Jorg Nieberg
      </a>{" "}
